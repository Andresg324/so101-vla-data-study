...
Six clips, overhead camera, real time unless noted. Encoded small for in-page playback;
the source episodes are in the datasets listed above.

| Clip | What it shows |
|------|---------------|
| [Clean success](media/clip1_clean_success.gif) | The reference behavior. |
| [Two inch offset](media/clip2_offset_2in.gif) | The sweep passes a cube two inches from the trained position and closes on nothing. Grasp bearing 20.35 deg against an in-distribution median of 20.72. |
| [No motion](media/clip3_no_motion.gif) | Randomized, different object. 38 s with a maximum joint deviation of 5.19 deg. Trimmed to 15 s. |
| [Drop, no recovery](media/clip4_drop_no_recovery.gif) | Recovery policy. The deliberate drop transfers at a median of −11.58 deg against a demonstrated −10.84. The re-grasp does not. This is the typical case. |
| [Drop then re-grasp](media/clip5_rare_regrasp.gif) | The rare case: 6 of 53 drop episodes, all at seed 2000. |
| [Correct aim, no grasp](media/clip6_correct_aim_no_grasp.gif) | Randomized at a held-out position. Commanded bearing 5.8 deg against a true 5.7. The arm points at the cube and still fails to close on it. |
