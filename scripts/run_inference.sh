...
case "$CELL" in
    in_distribution|new_positions|reduced_lighting|different_object|distractors|near_1in|near_2in|trained_t2|spot_check|in_distribution_rebuilt|new_positions_rebuilt|reach_e5) ;;
    *) echo "unknown cell '$CELL'"; exit 1 ;;
esac

case "$POLICY" in
    clean|randomized|recovery|color|color-slowpace|density|clean-seed2000|randomized-seed2000|color-seed2000|recovery-seed2000|density5|density10|density25|density50|density5-seed2000|density10-seed2000|density25-seed2000|density50-seed2000|density25-fixedstep|density50-fixedstep|randomized-runpod) ;;
